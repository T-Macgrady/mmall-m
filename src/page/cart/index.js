...
var page = {
    ...
    bindEvent : function(e){
        var _this = this;
        // 商品数量的变化
        $(document).on('click', '.count-change-btn', function(){
            var $this       = $(this),
                $pCount     = $this.siblings('.cart-info-count'),
                currCount   = parseInt($pCount.val()),
                type        = $this.hasClass('cart-plus') ? 'cart-plus' : 'cart-minus',
        ...
        // 商品的全选 / 取消全选
        $(document).on('click', '.cart-allCheck', function(){
            var $this = $(this);
            // 全选
            if($this.is(':checked')){
        ...
        $(document).on('click', '.delete-selected', function(){
            if(window.confirm('确认要删除选中的商品？')){
                var arrProductIds = [],
                    $selectedItem = $('.singleCheck:checked');
                // 循环查找选中的productIds
